...
namespace _2048_Game
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e) //otwarcie formy oraz ladowanie tla programu
        {
        ...
        PictureBox background = new PictureBox(); // zostaja wuswietlone 2 pierwsze klocki z liczba 2 lub 4 
        ...
        public void Stack() // metoda tworzaca stos danych
        {
        ...
        public void SpawnNumbers() //przepisanie indeksow do plikow
        {
        ...
        public void Draw()  // inicyalizacja plików wejsiowych oraz tworzenie macierzy 
        {
            if (!GameOwer.Visible)
            {
        ...
        public void Down() // przesuniecie klockow w dol 
        {
        ...
        public void Left() //przesuniecie klockow w lewo
        {
        ...
        public void Up() // przesuniecie klockow w gore
        {
            for (int i = 0; num_matrix.GetLength(1) > i; i++)
            {
        ...
        public void Right() //przesuniecie klockow w prawo
        {
            for (int j = 0; num_matrix.GetLength(1) > j; j++)
            {
        ...
        private void K_D(object sender, KeyEventArgs e) // odczyt tego jaki klawisz zostal wczysniety 
        {
            if (!GameOwer.Visible)
            {
                switch (e.KeyCode)
        ...
        private void start_Click_1(object sender, EventArgs e) // urochamenie gry po klikniecu "start"
        {
            scores.Text = "0";
            UpDate.Start();
            if (GameOwer.Visible)
        ...
        private void GameOwer_Click(object sender, EventArgs e)
        {
